...
public sealed class KeepMinizippersMod : IMod
{
    /// <summary>
    ...
    /// </summary>
    public KeepMinizippersMod(KeepMinizippersModConfig modConfig, CoreMod coreMod, BaseMod baseMod)
    {
    ...
    {
        TransportsManagerPatches.Initialize(this.modConfig);
